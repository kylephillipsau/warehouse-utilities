...
The design is specified to a level it could be built from: thirty-six recorded
...
There are thirty-six recorded decisions, around sixty rules the design must always
...
One technical question wants settling before the first database work, and it is a
measurement rather than a decision. Around fifty others are open, each either
deferred against a stated trigger or waiting on an answer only the business has. All of them are listed in
...
- `domain-model.md`, the full decision record, thirty-six decisions with the
